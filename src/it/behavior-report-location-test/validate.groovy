...
report = new File('src/it/behavior-report-location-test/target/easyb-report.xml')
...
storyReport = new File('src/it/behavior-report-location-test/target/easyb/stories.txt')
